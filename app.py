...
cursor=db.cursor()
"""
db=pymysql.Connect(host="localhost",user="root",password="swapnil",port=3306)
cursor = db.cursor()
cursor.execute("drop database if exists test;")
cursor.execute ("create database if not exists test;")
db.close()
db=pymysql.Connect(host="localhost",user="root",database="test",password="swapnil",port=3306)
cursor=db.cursor()
"""
